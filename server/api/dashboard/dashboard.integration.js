...
describe('Dashboard API:', function() {
  ...
  describe('PUT /api/dashboards/:id', function() {
    ...
    it('should respond with the original dashboard', function() {
      updatedDashboard.name.should.equal('New Dashboard');
      updatedDashboard.info.should.equal('This is the brand new dashboard!!!');
    });
  ...
  describe('PATCH /api/dashboards/:id', function() {
    ...
    beforeEach(function(done) {
      request(app)
        .patch(`/api/dashboards/${newDashboard._id}`)
        .send([
