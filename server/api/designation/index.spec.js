...
var designationCtrlStub = {
  ...
  upsert: 'designationCtrl.upsert',
  patch: 'designationCtrl.patch',
...
describe('Designation API Router:', function() {
  ...
  describe('PUT /api/designations/:id', function() {
    it('should route to designation.controller.upsert', function() {
      routerStub.put
        .withArgs('/:id', 'designationCtrl.upsert')
        .should.have.been.calledOnce;
    });
  });

  describe('PATCH /api/designations/:id', function() {
    it('should route to designation.controller.patch', function() {
      routerStub.patch
        .withArgs('/:id', 'designationCtrl.patch')
        .should.have.been.calledOnce;
    });
  });
